...
public class SharedParametersController {
    ...
    public SharedParametersController(SharedParametersRepository sharedParametersRepository, SharedParametersServiceImpl sharedParametersService) {
    ...
    Map<String, Object> putParam(String key, String value) {
        if (key != null && value != null) {
            ...
            sharedParametersRepository.save(new SharedParam(key, value));
    ...
    Map<String, SharedParam> getMap() {
        System.out.println("OH RIGHT HERE");
